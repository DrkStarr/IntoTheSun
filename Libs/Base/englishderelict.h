...
!  LMode1:   print (string) Story; " does not have ~brief~ mode. It has been disabled.";
!  LMode2:   print (string) Story; " is now in its ~verbose~ mode, which always gives long descriptions
!             of locations (even if you've been there before).";
  LMode3:   print (string) Story; " does not have ~superbrief~ mode. It has been disabled.";
...
! Push: see Pull
  ...
  Sing:     "Not exactly your strong suit. You keep quiet.";
